...
async function main() {
    ...
    const newsSources = await Promise.all([
        { name: 'Nairametrics', slug: 'nairametrics', baseUrl: 'https://nairametrics.com', fetchStrategy: client_1.FetchStrategy.RSS },
        { name: 'Punch Business', slug: 'punch-business', baseUrl: 'https://punchng.com/topics/business/', fetchStrategy: client_1.FetchStrategy.RSS },
        { name: 'The Guardian Business', slug: 'guardian-business', baseUrl: 'https://guardian.ng/category/business-services/', fetchStrategy: client_1.FetchStrategy.RSS },
        { name: 'BusinessDay', slug: 'businessday', baseUrl: 'https://businessday.ng', fetchStrategy: client_1.FetchStrategy.RSS },
        { name: 'TechCabal', slug: 'techcabal', baseUrl: 'https://techcabal.com', fetchStrategy: client_1.FetchStrategy.RSS },
        { name: 'Techpoint Africa', slug: 'techpoint-africa', baseUrl: 'https://techpoint.africa', fetchStrategy: client_1.FetchStrategy.RSS },
        { name: 'CoinGecko', slug: 'coingecko', baseUrl: 'https://www.coingecko.com', fetchStrategy: client_1.FetchStrategy.API },
    ...
    for (const provider of stockProviders) {
        await prisma.providerStatusLog.create({
            data: {
                ...
                status: provider.slug === 'ngx' ? client_1.ProviderHealthStatus.HEALTHY : client_1.ProviderHealthStatus.DEGRADED,
    ...
    await prisma.watchlist.upsert({
        ...
        create: {
            ...
            items: {
                create: [
                    { assetType: client_1.AssetType.STOCK, assetSymbol: 'ACCESSCORP', position: 0 },
    ...
    const portfolioAssets = [
        { assetType: client_1.AssetType.STOCK, assetSymbol: 'ACCESSCORP', quantity: 1250, buyPrice: 19.8, notes: 'Long-term NGX banking exposure' },
        { assetType: client_1.AssetType.STOCK, assetSymbol: 'MTNN', quantity: 75, buyPrice: 210, notes: 'Quality telecom cash flow play' },
        { assetType: client_1.AssetType.CRYPTO, assetSymbol: 'BTC', quantity: 0.12, buyPrice: 82500, notes: 'Core crypto allocation' },
        { assetType: client_1.AssetType.CRYPTO, assetSymbol: 'ETH', quantity: 1.5, buyPrice: 2950, notes: 'Smart contract ecosystem bet' },
    ];
